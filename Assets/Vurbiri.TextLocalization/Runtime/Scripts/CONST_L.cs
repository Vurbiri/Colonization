...
namespace Vurbiri.TextLocalization
{
    public static class CONST_L
    {
        ...
        public const string RESOURCES_PATH = "Assets/Vurbiri.TextLocalization/Runtime/Resources";

        public const string PROJECT_SETTINGS_NAME = "LocalizationProjectSettings";
        public const string PROJECT_SETTINGS_PATH = RESOURCES_PATH + PROJECT_SETTINGS_NAME + "." + ASSET_EXP;
    }
}
