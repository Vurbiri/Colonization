...
{
	public abstract class ReactiveValue<T> : Reactive<T>, IReactiveValue<T> where T : struct, IEquatable<T>, IComparable<T>
	{
		public new T Value
		{
			[Impl(256)] get => _value;
		...
		[Impl(256)] protected ReactiveValue(T value) => _value = value;
		[Impl(256)] protected ReactiveValue() { }
