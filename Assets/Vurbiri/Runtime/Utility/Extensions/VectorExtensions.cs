...
namespace Vurbiri
{
	...
	{
		[Impl(256)] public static float SqrDistance(this in Vector3 self, in Vector3 other)
		{
		...
		#region Set Axis
		[Impl(256)] public static Vector3 Set(this Vector3 self, int axis, float value)
		{
			self[axis] = value;
			return self;
		}
		...
		[Impl(256)] public static Vector2 Set(this Vector2 self, int axis, float value)
		{
			self[axis] = value;
			return self;
		}
		...
		#region Offset Axis
		[Impl(256)] public static Vector3 Offset(this Vector3 self, int axis, float value)
		{
			self[axis] += value;
			return self;
		}
		...
		[Impl(256)] public static Vector2 Offset(this Vector2 self, int axis, float value)
		{
			self[axis] += value;
			return self;
		}
