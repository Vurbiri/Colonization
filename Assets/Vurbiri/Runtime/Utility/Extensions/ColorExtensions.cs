...
namespace Vurbiri
{
	public static class ColorExtensions
	{
		...
		[Impl(256)] public static string ToHex(this in Color self) => $"#{ToByte(self.r):X2}{ToByte(self.g):X2}{ToByte(self.b):X2}{ToByte(self.a):X2}";
		
		[Impl(256)] public static Color32 ToColor32(this in Color self) => new(ToByte(self.r), ToByte(self.g), ToByte(self.b), ToByte(self.a));
		...
		[Impl(256)] public static ref Color SetOwnComponent(this ref Color self, int component, float value)
		{
			self[component] = value;
			return ref self;
		}
