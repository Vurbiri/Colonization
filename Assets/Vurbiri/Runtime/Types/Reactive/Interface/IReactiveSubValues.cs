...
namespace Vurbiri.Reactive
{
    public interface IReactiveSubValues<T, U> : IReactive<T> where U : AIdType<U>
    {
        ...
        public IUnsubscriber Subscribe(int index, Action<int> action, bool calling = true);
        public IUnsubscriber Subscribe(Id<U> id, Action<int> action, bool calling = true);
