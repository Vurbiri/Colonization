...
namespace VurbiriEditor.Colonization
{
    ...
    internal class PricesEditor : AEditorGetVE<PricesEditor>
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                root.Q<PropertyField>(EdificeId.GetName_Ed(i)).BindProperty(propertyValues.GetArrayElementAtIndex(i));
            }
            ...
            {
                root.Q<PropertyField>(WarriorId.GetName_Ed(i)).BindProperty(propertyValues.GetArrayElementAtIndex(i));
            }
