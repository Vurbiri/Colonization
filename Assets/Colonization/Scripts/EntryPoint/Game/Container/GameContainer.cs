...
namespace Vurbiri.Colonization
{
	public class GameContainer : ProjectContainer
    {
        ...
        public static HumanController Person            { [Impl(256)] get => s_content.players.Person; }
        public static SatanController Satan             { [Impl(256)] get => s_content.players.Satan; }
        public static ReadOnlyArray<HumanController> Humans { [Impl(256)] get => s_content.players.Humans; }
