...
namespace VurbiriEditor.Colonization
{
	public class UISettings_Editor : MonoBehaviour, ICanvasElement
    {
        ...
        [SerializeField, Range(1f, 3f)] private float _pixelsPerUnit = 1.6f;
        [SerializeField, Button("UpdateVisual"), Range(1f, 2f)] private float _pixelsPerUnitRate = 1.3f;
        [Space]
        ...
        public void UpdateVisual()
        {
            ...
            _playerPanels.UpdateVisuals_Editor(_pixelsPerUnit * _pixelsPerUnitRate, _colors, _screenPadding);
            _perksWindow.UpdateVisuals_Ed(_pixelsPerUnit, _colors);
            _exchangeWindow.UpdateVisuals_Editor(_pixelsPerUnit, _colors);
            _giftWindow.UpdateVisuals_Editor(_pixelsPerUnit, _colors);
        }
