...
{
    sealed public class AddTargetEffect : AAddHitEffect
    {
        public AddTargetEffect(EffectCode code, int targetAbility, Id<TypeModifierId> typeModifier, int value, int duration) :
