...
namespace Vurbiri.Colonization
{
    public class ReadOnlyAbilities<TId> : IReadOnlyList<Ability> where TId : AbilityId<TId>
    {
        ...
        [Impl(256)] public ArrayEnumerator<AAbility<TId>> GetEnumerator() => _abilities.GetEnumerator();
        IEnumerator<Ability> IEnumerable<Ability>.GetEnumerator() => _abilities.GetEnumerator();
