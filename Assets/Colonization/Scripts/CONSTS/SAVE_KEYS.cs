...
namespace Vurbiri.Colonization.Data
{
    public static class SAVE_KEYS
    {
        ...
        public const string P_RESOURCES = "rs", P_ROADS = "rd", P_EDIFICES = "ed", P_ACTORS = "a", P_ARTEFACT = "ar", P_BUFFS = "bf", P_PERKS = "pk", P_SATAN = "sat";
                
        public const string G_MODE = "gs", G_MAX_SCORE = "ms", G_VISUAL_PLAYER_IDS = "vp";

        public const int DEFOULT_COUNT_KEYS_ACTORS = 7;
    }
}
