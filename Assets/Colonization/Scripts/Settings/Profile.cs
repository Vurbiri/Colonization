...
#if YSDK
        [Impl(256)] public void Init(Vurbiri.Yandex.YandexSDK ysdk)
		{
			_idLang = ysdk.IsInitialize ? Localization.Instance.IdFromCode(ysdk.Lang) : Localization.Instance.GetDefaultId();
		}
#else
		[Impl(256)] public void Init() => _idLang = Localization.Instance.GetDefaultId();
#endif
