...
namespace Vurbiri.UI
{
	...
	public partial class VSelectable : Selectable
	{
		...
		public bool Unlock
		{
			[Impl(256)] get => base.interactable;
			[Impl(256)] set
			{
				if (base.interactable != value && _lockIcon != null)
				{
		...
		public RectTransform RectTransform { [Impl(256)] get => _thisRectTransform; }

        public int TargetGraphicCount { [Impl(256)] get => _targetGraphics.Count; }
        #endregion

        [Impl(256)] public Graphic GetTargetGraphic(int index) => _targetGraphics[index].Graphic;

		[Impl(256)] public void InteractableAndUnlock(bool interactable, bool unlocked)
		{
