...
namespace VurbiriEditor.International
{
	internal class CONST
	{
		...
		public const string EDITOR_FOLDER = "Assets/Localization/Editor/";
		public const string RESOURCES_FOLDER = "Assets/Localization/Resources/";

		public const string FILE_LANG = CONST_L.LANG_FILE;
		public const string FILE_LANG_PATH = RESOURCES_FOLDER + FILE_LANG + JSON_EXP;

		public const string FILE_FILES = CONST_L.FILES_FILE;
		public const string FILE_FILES_PATH = RESOURCES_FOLDER + FILE_FILES + JSON_EXP;

		public const string LANG_LIST = "LanguageList";

		public const string LANG_TYPES_NAME = "LanguageTypes";
		public const string LANG_TYPES_PATH = EDITOR_FOLDER + LANG_TYPES_NAME + ASSET_EXP;

		public const string LANG_FILES_NAME = "LanguageFiles";
		public const string LANG_FILES_PATH = EDITOR_FOLDER + LANG_FILES_NAME + ASSET_EXP;

		public const string LANG_STRING_NAME = "LanguageStrings";
		public const string LANG_STRING_PATH = EDITOR_FOLDER + LANG_STRING_NAME + ASSET_EXP;
