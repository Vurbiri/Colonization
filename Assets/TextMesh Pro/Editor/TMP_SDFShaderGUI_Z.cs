...
{
    public class TMP_SDFShaderGUI_Z : TMP_BaseShaderGUI
    {
        private static ShaderFeature s_OutlineFeature, s_UnderlayFeature, s_BevelFeature, s_GlowFeature, s_MaskFeature;
        private static bool s_Face = true, s_Outline = true, s_Outline2, s_Underlay, s_Lighting, s_Glow, s_Bevel, s_Light, s_Bump, s_Env;
        ...
        protected static GUIContent[] s_ZTestTypeLabels =
        {
            new("Disabled"),
            new("Never"),
            new("Less"),
        ...
        private void DoFacePanel()
        {
            ...
            if (m_Material.HasProperty("_ZTest"))
            {
                ...
                DoPopup("_ZTest", "ZTest", s_ZTestTypeLabels);
                EditorGUILayout.Space();
            }
        ...
        private static GUIContent[] s_BevelTypeLabels =
        {
